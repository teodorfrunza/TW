...
if ($check != false) {
    ...
    echo "<script type='text/javascript'>alert('$message'); window.location.href = \"../cerereVizita.html\";</script>";
    $uploadOk = 0;
}
...
//stid3
            ...
            if ($count2 == 0) {
                ...
                if ($count == 0) {
                    ...
                    echo "<script type='text/javascript'>alert('$message'); window.location.href = \"../panouVizitatori.html\";</script>";
                } else {
