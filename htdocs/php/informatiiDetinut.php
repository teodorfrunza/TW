...
if (is_numeric($var) == true) {
    ...
    if ($count2 == 0) {
        ...
        echo "<script type='text/javascript'>alert('$message'); window.location.href = \"../codDetinut.html\";</script>";
    } else {
        $r = oci_execute($stid);
        if (!$r) {
            $e = oci_error($stid);
...
<head>
    <meta charset="UTF-8">
    <title>Detinut</title>
    <link rel="stylesheet" type="text/css" href="../css/prezentareDetinut.css">
    <meta name="viewport" content="width=device-width,height=device-height,initial-scale=1.0">
</head>

<body>
<div class="Container">
    <img src="../poze/<?php echo htmlspecialchars($poza); ?>" alt="Person" class="imagine">
    <li>
    ...
    <a href="../codDetinut.html" class="Buton2">Inapoi</a>
    <img class="Poza" src="../poze/backgroundSters.jpg" alt="Imagine inchisoare">
</div>
</body>
