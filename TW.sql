...
/
CREATE TABLE DETINUTI (ID NUMBER(10) PRIMARY KEY, NUME VARCHAR2(50) NOT NULL, PRENUME VARCHAR2(50) NOT NULL, DATA_NASTERE DATE NOT NULL, DURATA_PEDEAPSA VARCHAR2(10) NOT NULL, MOTIV VARCHAR2(200) NOT NULL, SANATATE VARCHAR2(500) NOT NULL);
/
...
/
INSERT INTO DETINUTI VALUES (1010, 'Frunza', 'Teodor', TO_DATE('25-JAN-1996','DD-MON-YYYY'), '3 ANI', 'JAF ARMAT', 'SINDROM TOURETTE');
INSERT INTO DETINUTI VALUES (1011, 'Rosca', 'Alexandru', TO_DATE('23-JUL-1997','DD-MON-YYYY'), '3 ANI', 'PRADATOR SEXUAL', 'HEMOROIZI');
INSERT INTO DETINUTI VALUES (1012, 'Borcan', 'Vasile', TO_DATE('08-FEB-1870','DD-MON-YYYY'), '2 ANI', 'FURT MASINA', 'SANATOS');
INSERT INTO DETINUTI VALUES (1013, 'Oieru', 'Costica', TO_DATE('13-MAY-1868','DD-MON-YYYY'), '3 LUNI', 'NUDISM IN PLUBLIC', 'SANATOS');
INSERT INTO DETINUTI VALUES (1014, 'Oprea', 'Ionut', TO_DATE('17-APR-1860','DD-MON-YYYY'), '7 ANI', 'VIOL', 'HEPATITCA C');
INSERT INTO DETINUTI VALUES (1015, 'Ionescu', 'Gheorghita', TO_DATE('17-DEC-1890','DD-MON-YYYY'), '2 ANI', 'VIOLENTA DOMESTICA', 'SANATOS');
INSERT INTO DETINUTI VALUES (1016, 'Covrig', 'Ionel', TO_DATE('13-MAY-1840','DD-MON-YYYY'), '4 ANI', 'FURT CALIFICAT', 'TUBERCULOZA');
INSERT INTO DETINUTI VALUES (1017, 'Rosu', 'Cristian' , TO_DATE('27-JUN-1850','DD-MON-YYYY'), '5 ANI', 'UCIDERE DIN CULPA', 'SANATOS');
INSERT INTO DETINUTI VALUES (1018, 'Chioru', 'Vasile', TO_DATE('27-JUN-1870','DD-MON-YYYY'), '3 ANI', 'JAF', 'SANATOS');
INSERT INTO DETINUTI VALUES (1019, 'Capatos', 'Mirel', TO_DATE('25-AUG-1850','DD-MON-YYYY'), '7 ANI', 'NUDISM IN BISERICA', 'GRIPAT');
/
