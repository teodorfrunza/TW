...
/
CREATE TABLE LOGIN (USERNAME VARCHAR2(50) UNIQUE, PASSWORD VARCHAR2(50) NOT NULL, NUME VARCHAR2(100) NOT NULL, PRENUME VARCHAR2(100) NOT NULL, DATA_NASTERE DATE NOT NULL, INTREBARE VARCHAR2(200), RASPUNS VARCHAR2(200));
/
...
/
INSERT INTO LOGIN VALUES ('admin', 'admin','BlackHat','Hacker',TO_DATE('25-JAN-1976','DD-MON-YYYY'),'Care e numele scolii tale primare?','puscarie');
INSERT INTO LOGIN VALUES ('GUARD263', '12345678','Ababei','Marius',TO_DATE('02-APR-1975','DD-MON-YYYY'),'Care este filmul tau preferat?','Home Alone');
INSERT INTO LOGIN VALUES ('GUARD69', '87654321','Ciorbei','Vasile',TO_DATE('21-FEB-1985','DD-MON-YYYY'),'Care este artistul tau preferat?','Justin Bieber');
INSERT INTO LOGIN VALUES ('DIRECTOR', 'MUHAHAHAHA','Borcea','Cristinel',TO_DATE('27-AUG-1982','DD-MON-YYYY'),'Care este orasul in care te-ai nascut?','Vaslui');
/
