...
/
CREATE TABLE LOGIN (USERNAME VARCHAR2(50) UNIQUE, PASSWORD VARCHAR2(50) NOT NULL, NUME VARCHAR2(100) NOT NULL, PRENUME VARCHAR2(100) NOT NULL, CNP NUMBER(15) UNIQUE NOT NULL, DATA_NASTERE DATE NOT NULL, INTREBARE VARCHAR2(200), RASPUNS VARCHAR2(200));
/
...
/
INSERT INTO LOGIN VALUES ('admin', 'admin','BlackHat','Hacker',176012585978,TO_DATE('25-JAN-1976','DD-MON-YYYY'),'Care e numele scolii tale primare?','puscarie');
INSERT INTO LOGIN VALUES ('GUARD263', '12345678','Ababei','Marius',1750402859741,TO_DATE('02-APR-1975','DD-MON-YYYY'),'Care este filmul tau preferat?','Home Alone');
INSERT INTO LOGIN VALUES ('GUARD69', '87654321','Ciorbei','Vasile',1850221965478,TO_DATE('21-FEB-1985','DD-MON-YYYY'),'Care este artistul tau preferat?','Justin Bieber');
INSERT INTO LOGIN VALUES ('DIRECTOR', 'MUHAHAHAHA','Borcea','Cristinel',182082785965,TO_DATE('27-AUG-1982','DD-MON-YYYY'),'Care este orasul in care te-ai nascut?','Vaslui');
/
...
INSERT INTO DETINUTI VALUES (1012, 'Gavrilita', 'Rolland', TO_DATE('08-FEB-1995','DD-MON-YYYY'), '2 ANI', 'FURT MASINA', 'SANATOS', 'poza3.jpg');
INSERT INTO DETINUTI VALUES (1013, 'Oieru', 'Costica', TO_DATE('13-MAY-1960','DD-MON-YYYY'), '3 ANI', 'NUDISM IN PLUBLIC', 'SANATOS', 'poza4.jpg');
