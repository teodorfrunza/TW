...
/
CREATE TABLE LOGIN (USERNAME VARCHAR2(50) UNIQUE, PASSWORD VARCHAR2(50) NOT NULL, INTREBARE VARCHAR2(200), RASPUNS VARCHAR2(500));
/
...
/
INSERT INTO LOGIN VALUES ('admin', 'admin','Care e numele scolii tale primare?','puscarie');
INSERT INTO LOGIN VALUES ('GUARD263', '12345678','Care este filmul tau preferat?','Home Alone');
INSERT INTO LOGIN VALUES ('GUARD69', '87654321','Care este artistul tau preferat?','Justin Bieber');
INSERT INTO LOGIN VALUES ('DIRECTOR', 'MUHAHAHAHA','Care este orasul in care te-ai nascut?','Vaslui');
/
