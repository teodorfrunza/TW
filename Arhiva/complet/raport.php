...
if(is_numeric($var1)==true) {
    ...
    if ($count == 0) {
        ...
        echo "<script type='text/javascript'>alert('$message'); window.location.href = \"raportV.html\";</script>";
    } else {
        ...
        if ($count2 == 0) {
            ...
            echo "<script type='text/javascript'>alert('$message'); window.location.href = \"employPanel.html\";</script>";
        }
        else {
